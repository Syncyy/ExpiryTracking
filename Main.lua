EventUtil.ContinueOnAddOnLoaded("ExpiryTracking", function()
  local frame = CreateFrame("Frame", "ExpiryTrackingFrame", UIParent, "ButtonFrameTemplate")
  frame:Hide()
  ...
  view:SetElementInitializer("Frame", function(f, data)
    ...
    if data.expirationTime ~= 0 then
      text = date("%X", (data.expirationTime-currentTime)-3600)
  ...
  SlashCmdList["ExpiryTracking"] = function()
    frame:Show()
  end
  SLASH_ExpiryTracking1 = "/etr"
  SLASH_ExpiryTracking2 = "/etr"
end)
